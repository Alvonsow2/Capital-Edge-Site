...
const AppWrapper = observer(() => {
    ...
    return (
        <React.Fragment>
            <div className={classNames('main', { 'main--embed': active_tab === 7 })}>
                <div
                        ...
                        <Tabs active_index={active_tab} className='main__tabs' onTabItemClick={handleTabChange} top>
                            ...
                            <div
                                label={
                                    <>
                                        <span className='ce-tab-icon'>💻</span>
                                        <Localize i18n_default_text='Trading Software' />
                                    </>
                                }
                                id='id-free-bots'
                            >
                            ...
                            <div
                                ...
                                id='id-trading-view-embed'
                            >
                                <div className='embed-tab-wrapper'>
                                    <iframe
                                        src='https://charts.deriv.com/deriv'
                                        title='Trading View'
                                        className='embed-tab-iframe'
                                        allow='fullscreen'
